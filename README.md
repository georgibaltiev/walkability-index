...
# Калкулатор за индекс на пешеходна достъпност в райони "Люлин" и "Връбница"
...
> [!IMPORTANT]  
> В момента калкулаторът работи с доста ограничен набор от геоданни, с цел забързване на изчисленията
